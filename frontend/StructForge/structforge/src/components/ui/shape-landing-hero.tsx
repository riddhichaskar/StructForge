        ...
        <div className="relative min-h-screen w-full bg-[#030303] overflow-x-hidden">
            ...
            */}
            <div className="absolute inset-0 h-full w-full z-0 pointer-events-none overflow-hidden">
                ...
                {/* --- EXTENDED SHAPES (Scroll Down Area) --- */}
                {/* These shapes are positioned lower down (top > 100%) to appear when scrolling */}
