...
// --- Data Arrays (Fixed: Added these back) ---
        ...
        >
                        ...
                        <NavigationMenuList className="gap-2">
                                ...
                                <NavigationMenuContent className="bg-popover">
                                    <div className="grid w-[600px] grid-cols-2 gap-5 p-4">
                                        ...
                                        <div className="flex flex-col gap-2 border-l pl-4 border-border">
                                            ...
                                            <ul className="space-y-1">
                                                <ListItem title="CLI" href="#" icon={Terminal} description="Command line interface tool" />
                                                <ListItem title="VS Code Extension" href="#" icon={Code} description="Integrate directly into your editor" />
                                            </ul>
                                        </div>
                                    </div>
                                </NavigationMenuContent>
                                    ...
                                    <div className="grid w-[500px] grid-cols-2 gap-5 p-4">
                                        ...
                                        <ul className="space-y-2 border-l pl-4 border-border">
                                            {companyLinks2.map((item, i) => (
                                                <li key={i}>
                                                    <NavigationMenuLink href={item.href} className="flex p-2 hover:bg-accent hover:text-accent-foreground flex-row rounded-md items-center gap-x-3 transition-colors">
                            ...
                            <NavigationMenuItem>
                                <NavigationMenuLink className="px-4 py-2" asChild>
                                    <a href="#" className="hover:bg-accent hover:text-accent-foreground rounded-md text-lg font-medium transition-colors">Pricing</a>
                                </NavigationMenuLink>
                            </NavigationMenuItem>
                        </NavigationMenuList>
                    </NavigationMenu>
            ...
            <MobileMenu open={open}>
                <div className="flex flex-col gap-4">
                   ...
                   <ListItem title="Convert Text → Directory" href="/actions/text-to-dir" icon={FolderTree} />
...
function MobileMenu({ open, children, className, ...props }: MobileMenuProps) {
    ...
    return createPortal(
        <div className={cn('bg-background/95 fixed top-16 right-0 bottom-0 left-0 z-40 flex flex-col overflow-hidden border-t md:hidden', className)}>
